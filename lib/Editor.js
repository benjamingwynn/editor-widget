  ...
  self.on('keypress', function (ch, key) {
    ...
    if (binding && ['go', 'select', 'delete'].some(function (action) {
      ...
      switch (binding) {
        ...
        case 'comment':
          // TODO: this will do something in the future?
          
          util.logger.debug("Insert comment for lang:", self.language());
          util.logger.silly("Insert future here.");
          util.logger.silly(selection);
          debugger;
